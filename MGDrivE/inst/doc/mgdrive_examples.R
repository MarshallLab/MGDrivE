...
moveMat <- matrix(data = c(0.95, 0.05, 0.01, 0.90),
...
#  There are 10 mosquitoes relaeses every time.
...
splitOutput(readDir = outFolder, verbose = FALSE)
...
dayOmega <- getOmega(mu = bioParameters$muAd, lifespanReduction = 0.60)
...
# Basic Inheritance pattern
####################
# Reciprocal translocation cube with standard (default) paraameters
