...
For this experiment, we use simple Mendelian inheritance. *MGDrivE* has several other inheritance patterns, which include:  
  ...
  * See [MGDrivE Mathematical Description](mgdrive_math.html) for a complete list
...
```{r, fig.alt="Example of how to plot a single repetition from a set of simulations."}
...
```{r, fig.alt="Example of how to plot all repetitions from a set of simulations."}
# plot all 5 repetitions together
plotMGDrivEMult(readDir=outFolder,lwd=0.35,alpha=0.75)
```
